/*
  Uses Hooke's Law: f = kX 
    where f = force (acceleration vector)
          k = stiffness of the spring (constant)
...
var canvas = document.getElementById("canvas"),
  ...
  springPoint = vector.create(width / 2, height / 2), // spring position
  weight = particle.create(Math.random() * width, Math.random() * height, 
              50, Math.random() * Math.PI * 2), // attached to spring
