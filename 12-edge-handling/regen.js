...
for(var i = 0; i < 100; i += 1) {
  var p = particle.create(width / 2, height, Math.random() * 8 + 5,
...
function update() {
  ...
  for(var i = 0; i < 100; i += 1) {
    ...
    // if falls off the bottom edge, refresh the particle
    // with new size, velocity, direction
